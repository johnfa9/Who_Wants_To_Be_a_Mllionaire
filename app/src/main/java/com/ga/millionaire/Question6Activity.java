...
public class Question6Activity extends AppCompatActivity implements QuestionDialog.QuestionDialogLister {

    private final int QUESTION_VALUE = 24000;
    ...
    public void returnAnswer(Boolean Answer) {
        //if user stops game, display their winning amount
        endGame=Answer;
        if (endGame) {
