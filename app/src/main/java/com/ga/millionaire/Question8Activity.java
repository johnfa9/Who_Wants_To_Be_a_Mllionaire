...
public class Question8Activity extends AppCompatActivity implements
        QuestionDialog.QuestionDialogLister {


    private final int QUESTION_VALUE = 125000;
    ...
    public void submitQuestion1(View view) {
        ...
        if (selectedId == -1){  //user selected a blank answer
            openDialog();
        }

        else if (radioButton.getId() == R.id.choiceA) {

            Intent nextQuestion = new Intent(this, Question9Activity.class);
            ...
            finalScore.putExtra(Question1Activity.EXTRA_SCORE, 4000);
