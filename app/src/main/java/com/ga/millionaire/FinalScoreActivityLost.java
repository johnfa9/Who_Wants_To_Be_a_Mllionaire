...
public class FinalScoreActivityLost extends AppCompatActivity {
    //displays the final game store

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_final_score_lost);
        ...
        vwScore.setBackgroundResource(R.drawable.btn_rounded_lost);
